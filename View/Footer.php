            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="footer-about-us">
                        <h2 style="font-family:Impact;"><span style="color:chartreuse ">H2LKE MOBILE</span></h2>
                       <address>
                        <h5 style="color: white">H2LKE MOBILE là đơn vị bán hàng chuyên cung cấp các sản phẩm công nghệ mới nhất và tốt nhất cho khách hàng</h5>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p><span style="color:chartreuse">H2LKE MOBILE - Nhóm H2LKE</span> <a href="index.php" target="_blank">h2lkemobile.com</a></p>
                    </div>
                </div>
                <div class="col-md-4">
